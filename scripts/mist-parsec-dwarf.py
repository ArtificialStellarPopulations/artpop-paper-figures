...
###############################################################################
mist_iso = Table.read('../data/mist_iso_logage_8.55_feh_m1.5.csv')
parsec_iso = Table.read('../data/parsec_iso_logage_8.55_feh_m1.5.csv')
...
fig.savefig('../figures/mist_vs_parsec_dwarf.png', dpi=250);
